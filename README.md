...
本项目采用自定义开源协议进行托管：
* **个人与学术非商业用途**：您可以自由地获取、修改和在非商业环境下运行本项目代码。
* **商业用途限制**：**禁止任何未经授权的商业用途**（包括但不限于将本项目用于商业产品、收费服务、或者在商业公司内部部署使用）。如需进行商业化部署、二次开发或商业运营，**必须获得作者的明确书面授权**。更多条款请参阅项目根目录下的 [LICENSE](file:///d:/Code/Go/Reveria/LICENSE) 文件。
